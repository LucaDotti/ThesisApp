...
import usi.justmove.gathering.surveys.config.Period;
...
import static usi.justmove.local.database.tables.DailyIntervalsTable.KEY_DAILY_INTERVALS_CONFIG_ID;
import static usi.justmove.local.database.tables.DailyIntervalsTable.KEY_DAILY_INTERVALS_ID;
import static usi.justmove.local.database.tables.DailyIntervalsTable.KEY_DAILY_INTERVALS_TIME_END;
import static usi.justmove.local.database.tables.DailyIntervalsTable.KEY_DAILY_INTERVALS_TIME_START;
