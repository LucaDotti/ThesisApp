...
public class PAMTable {
    ...
    public static final String KEY_PAM_NOTIFIED = "notified";
    public static final String KEY_PAM_EXPIRED = "expired";
    ...
    public static String getCreateQuery() {
        return "CREATE TABLE " + TABLE_PAM +
                "(" +
                    ...
                    KEY_PAM_NOTIFIED + " INTEGER, " +
                    KEY_PAM_EXPIRED + " INTEGER, " +
                    KEY_PAM_PERIOD + " TEXT, " +
    ...
    public static String[] getColumns() {
        String[] columns = {KEY_PAM_ID, KEY_PAM_TS, KEY_PAM_SCHEDULED_AT, KEY_PAM_COMPLETED, KEY_PAM_NOTIFIED,
                KEY_PAM_EXPIRED, KEY_PAM_PERIOD, KEY_PAM_IMAGE_ID, KEY_PAM_STRESS, KEY_PAM_SLEEP, KEY_PAM_LOCATION,
                KEY_PAM_TRANSPORTATION, KEY_PAM_ACTIVITIES, KEY_PAM_WORKLOAD, KEY_PAM_SOCIAL};
        return columns;
    }
}
