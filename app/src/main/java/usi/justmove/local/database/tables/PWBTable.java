...
public class PWBTable {
    ...
    public static final String KEY_PWB_EXPIRED = "expired";
    ...
    public static String[] getColumns() {
        String[] columns = {KEY_PWB_ID, KEY_PWB_TS, KEY_PWB_SCHEDULED_AT, KEY_PWB_COMPLETED, KEY_PWB_NOTIFIED, KEY_PWB_EXPIRED, KEY_PWB_Q1, KEY_PWB_Q2, KEY_PWB_Q3, KEY_PWB_Q4, KEY_PWB_Q5, KEY_PWB_Q6, KEY_PWB_Q7, KEY_PWB_Q8};
        return columns;
    }
